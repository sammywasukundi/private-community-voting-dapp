...
(function (PollStatus) {
  PollStatus[PollStatus['OPEN'] = 0] = 'OPEN';
  PollStatus[PollStatus['CLOSED'] = 1] = 'CLOSED';
...
class _PollResults_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
      total: _descriptor_1.fromValue(value_0),
      yes: _descriptor_1.fromValue(value_0),
      no: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.total).concat(_descriptor_1.toValue(value_0.yes).concat(_descriptor_1.toValue(value_0.no)));
  }
}

const _descriptor_2 = new _PollResults_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.voterIdentity) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named voterIdentity');
    }
    ...
    this.circuits = {
      vote: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(choice_0),
      ...
      getResults: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`getResults: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getResults',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._getResults_0(context, partialProofData);
    ...
    this.impureCircuits = {
      ...
      getResults: this.circuits.getResults
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('getResults', new __compactRuntime.ContractOperation());
  ...
  _voterIdentity_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.voterIdentity(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('voterIdentity',
                                 'return value',
                                 'voting.compact line 28 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _voterCommitment_0(secretId_0) {
    return this._persistentHash_0([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 58, 112, 114, 105, 118, 97, 116, 101, 118, 111, 116, 101, 58, 118, 111, 116, 101, 114, 0, 0, 0, 0, 0, 0]),
                                   secretId_0]);
  }
  _vote_0(context, partialProofData, choice_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            0,
                            'not open');
    const commitment_0 = this._voterCommitment_0(this._voterIdentity_0(context,
                                                                       partialProofData));
  ...
  _getResults_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
...
const _dummyContract = new Contract({ voterIdentity: (...args) => undefined });
